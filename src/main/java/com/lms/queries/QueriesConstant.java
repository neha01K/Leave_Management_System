...
public class QueriesConstant {
    ...
    public static String INSERT_EMPLOYEE_INTO_LOGIN =  "INSERT INTO loginDetails(employeeId) VALUES(?)";
    ...
    public static String ADDING_INTO_LEAVE_HISTORY = "INSERT INTO leave_history (employeeID, leaveType, leaveStartDate, leaveEndDate, leaveReason) VALUES (?, ?, ?, ?, ?)";
}
